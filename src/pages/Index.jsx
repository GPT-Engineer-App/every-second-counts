...
const Index = () => {
  ...
  return (
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center" bgImage="url('https://source.unsplash.com/random/1600x900')" bgSize="cover" bgPosition="center" bgRepeat="no-repeat" bgAttachment="fixed">
      <VStack spacing={4}>
